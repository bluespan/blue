module PagesHelper
  ...
  def blue_include
    ...
    concat javascript_include_tag "blue/wymeditor/plugins/blue/jquery.wymeditor.blue.insert_rule.js" if logged_in? 
  ...
  def global_verbiage(key, options = {}, &default_block)    
      ...
      if options[:return] == :concat
        concat output.force_encoding("UTF-8") if output
      else
        return output.force_encoding("UTF-8") if output
      end      
  end
