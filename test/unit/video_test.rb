...
class VideoTest < Test::Unit::TestCase
  ...
  context "Vimeo Videos" do
    should "return a listing by username" do
      Vimeo::Simple::User.expects(:clips).with("stevep").returns(results_for_find_by_username_stevep)
      
      videos = VideoType::Vimeo.find_by_username("stevep")
  ...
  def results_for_find_by_username_stevep
